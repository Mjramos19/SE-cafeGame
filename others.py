...
class Register(Counter):
    ...
    def __init__(self, x, y, iz_y, w=150, h=90):
        ...
        self.customer_image = IMAGE_LIBRARY["ladybug_register"]
    ...
    def take_order(self, screen, current_cust=None):
        ...
        Args:
            ...
            current_cust (Customer): The customer being served.
        """
        ...
        order_name = "???"
        if current_cust is not None and current_cust.ordered_item is not None:
            order_name = current_cust.ordered_item.get_name()

        # Speech bubble position - to the left of the customer
